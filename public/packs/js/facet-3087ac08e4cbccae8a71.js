...
/* harmony import */ var axios_on_rails__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! axios-on-rails */ "./node_modules/axios-on-rails/index.js");
/* harmony import */ var vue_star_rating__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! vue-star-rating */ "./node_modules/vue-star-rating/dist/star-rating.min.js");
/* harmony import */ var vue_star_rating__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(vue_star_rating__WEBPACK_IMPORTED_MODULE_10__);
...
/* harmony import */ var vue_eva_icons__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! vue-eva-icons */ "./node_modules/vue-eva-icons/dist/vue-eva.common.js");
/* harmony import */ var vue_eva_icons__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(vue_eva_icons__WEBPACK_IMPORTED_MODULE_13__);
...
vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_8__["default"].component('star-rating', vue_star_rating__WEBPACK_IMPORTED_MODULE_10___default.a);

vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_8__["default"].component('v-select', vue_select__WEBPACK_IMPORTED_MODULE_11___default.a);


vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_8__["default"].use(vue_eva_icons__WEBPACK_IMPORTED_MODULE_13___default.a);
document.addEventListener('DOMContentLoaded', function () {
  var app = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_8__["default"]({
    el: '#facet',
    data: function data() {
      return {
        all_label: '--- All ---',
    ...
    computed: {
      ...
      movieCategoriesWithRepeats: function movieCategoriesWithRepeats() {
        ...
        _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_7___default()(_context = this.movies_jsn).call(_context, function (element) {
          names.push(element.category.name);
        });

        var sorted_names = _babel_runtime_corejs3_core_js_stable_instance_sort__WEBPACK_IMPORTED_MODULE_6___default()(names).call(names); // with repetitions
      ...
      category_names_with_counts: function category_names_with_counts() {
        ...
        _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_7___default()(_context2 = app.movieCategoriesWithRepeats).call(_context2, function (x) {
      ...
      movieCategoryCounts: function movieCategoryCounts() {
        ...
        _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_7___default()(_context3 = app.movieCategoriesWithRepeats).call(_context3, function (x) {
          counts[x] = (counts[x] || 0) + 1;
        }); // https://stackoverflow.com/questions/14379274/how-to-iterate-over-a-javascript-object/14379304
      ...
      filteredMovies: function filteredMovies() {
        ...
        return _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_4___default()(_context4 = app.filteredMoviesWithoutPagination).call(_context4, function (row, index) {
      ...
      category_names: function category_names() {
        ...
        return _babel_runtime_corejs3_core_js_stable_instance_sort__WEBPACK_IMPORTED_MODULE_6___default()(category_names).call(category_names);
      },
      ...
      category_name_options: function category_name_options() {
        var arr = [];
        arr.push(this.all_label); //                arr.push(this.category_names);
    ...
    methods: {
      ...
      moviesByCategory: function moviesByCategory(movies) {
        ...
        return _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_4___default()(movies).call(movies, function (movie) {
          ...
          if (_this5.selected_category != '' && _this5.selected_category != _this5.all_label) {
            ...
            return _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_3___default()(_context5 = _this5.selected_category).call(_context5, movie.category.name); //                        return movie.category.name == ;
          } else {
            return true;
          }
        });
      ...
      total_stars: function total_stars(movie) {
        ...
        _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_7___default()(movie_ratings).call(movie_ratings, function (movie_rating) {
      ...
      getmovies: function getmovies() {
        ...
        var url = "/movies.json";
        axios_on_rails__WEBPACK_IMPORTED_MODULE_9__["default"].get(url).then(function (response) {
      ...
      invoke_destroy: function invoke_destroy(movie) {
        ...
        if (confirm('Are you sure?')) axios_on_rails__WEBPACK_IMPORTED_MODULE_9__["default"]["delete"](url).then(function (response) {})["catch"](function (e) {
          _this7.errors.push(e);
        });
        window.location.reload(true);
      },
      rate_movie: function rate_movie(movie) {
        axios_on_rails__WEBPACK_IMPORTED_MODULE_9__["default"].post('/ratings', {
...
/******/ });
//# sourceMappingURL=facet-3087ac08e4cbccae8a71.js.map