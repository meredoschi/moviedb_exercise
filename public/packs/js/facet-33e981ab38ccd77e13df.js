  ...
  var app = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_5__["default"]({
    ...
    methods: {
      ...
      invoke_destroy: function invoke_destroy(movie) {
        ...
        alert(movie.title + " will be removed from the list."); //window.location.reload(true);
        //                     let url=`http://localhost:3000/movies/` + movie.id;

        var url = "movies/" + movie.id;
        console.log(url);
        if (confirm('Are you really sure?')) axios_on_rails__WEBPACK_IMPORTED_MODULE_6__["default"]["delete"](url).then(function (response) {//    this.movies_json = this.movies_json.filter(movie => movie.id !== id)
        })["catch"](function (e) {
...
/******/ });
//# sourceMappingURL=facet-33e981ab38ccd77e13df.js.map