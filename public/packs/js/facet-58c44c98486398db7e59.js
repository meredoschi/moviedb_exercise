  ...
  var app = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_5__["default"]({
    ...
    methods: {
      ...
      invoke_destroy: function invoke_destroy(movie) {
        ...
        alert("Movie: " + movie.title + " will be removed!"); //window.location.reload(true);

        var url = "http://localhost:3000/movies/" + movie.id;
        console.log(url);
        axios_on_rails__WEBPACK_IMPORTED_MODULE_6__["default"]["delete"](url).then(function (response) {
          var _context2;

          _this7.movies_json = _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_4___default()(_context2 = _this7.movies_json).call(_context2, function (movie) {
            return movie.id !== id;
          });
        })["catch"](function (e) {
...
/******/ });
//# sourceMappingURL=facet-58c44c98486398db7e59.js.map