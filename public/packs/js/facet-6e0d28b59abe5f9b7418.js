    ...
    computed: {
      ...
      category_names_with_counts2: function category_names_with_counts2() {
        ...
        for (var i = 0; i < this.total_number_of_movies; i++) {
          ...
          //      cat_names.push(name);
        } //    let obj=category_names.reduce((b,c)=>((b[b.findIndex(d=>d.el===c)]||b[b.push({el:c,count:0})-1]).count++,b),[]);
        //      console.log(obj);
        //    return obj;
      ...
      category_name_options: function category_name_options() {
        ...
        arr.push("Action (4)");
        arr.push("Drama (5)"); //  arr.push(this.category_names);

        console.log(this.category_names); //                console.log(this.category_name_options_revised)
      ...
      category_name_options_ok: function category_name_options_ok() {
        var arr = [];
        arr.push(this.all_label);
...
/******/ });
//# sourceMappingURL=facet-6e0d28b59abe5f9b7418.js.map