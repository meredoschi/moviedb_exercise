...
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_instance_flat__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js-stable/instance/flat */ "./node_modules/@babel/runtime-corejs3/core-js-stable/instance/flat.js");
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_instance_flat__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs3_core_js_stable_instance_flat__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var axios_on_rails__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! axios-on-rails */ "./node_modules/axios-on-rails/index.js");
...
/* harmony import */ var vue_eva_icons__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! vue-eva-icons */ "./node_modules/vue-eva-icons/dist/vue-eva.common.js");
/* harmony import */ var vue_eva_icons__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(vue_eva_icons__WEBPACK_IMPORTED_MODULE_10__);
...
vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_5__["default"].component('star-rating', vue_star_rating__WEBPACK_IMPORTED_MODULE_7___default.a);

vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_5__["default"].component('v-select', vue_select__WEBPACK_IMPORTED_MODULE_8___default.a);


vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_5__["default"].use(vue_eva_icons__WEBPACK_IMPORTED_MODULE_10___default.a);
document.addEventListener('DOMContentLoaded', function () {
  var app = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_5__["default"]({
    el: '#facet',
    data: function data() {
      return {
        all_label: '--- All ---',
    ...
    computed: {
      ...
      filteredMovies: function filteredMovies() {
        ...
        return _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_4___default()(_context = app.filteredMoviesWithoutPagination).call(_context, function (row, index) {
      ...
      category_names: function category_names() {
        ...
        return _babel_runtime_corejs3_core_js_stable_instance_sort__WEBPACK_IMPORTED_MODULE_2___default()(category_names).call(category_names);
      },
      category_name_options: function category_name_options() {
        var arr = [];
        arr.push(this.all_label);
        arr.push(this.category_names);
        return _babel_runtime_corejs3_core_js_stable_instance_flat__WEBPACK_IMPORTED_MODULE_1___default()(arr).call(arr);
      },
    ...
    methods: {
      ...
      total_stars: function total_stars(movie) {
        ...
        _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_0___default()(movie_ratings).call(movie_ratings, function (movie_rating) {
      ...
      getmovies: function getmovies() {
        ...
        var url = "/movies.json";
        axios_on_rails__WEBPACK_IMPORTED_MODULE_6__["default"].get(url).then(function (response) {
      ...
      invoke_destroy: function invoke_destroy(movie) {
        ...
        if (confirm('Are you sure?')) axios_on_rails__WEBPACK_IMPORTED_MODULE_6__["default"]["delete"](url).then(function (response) {})["catch"](function (e) {
          _this7.errors.push(e);
        });
        window.location.reload(true);
      },
      rate_movie: function rate_movie(movie) {
        axios_on_rails__WEBPACK_IMPORTED_MODULE_6__["default"].post('/ratings', {
  ...
  axios_on_rails__WEBPACK_IMPORTED_MODULE_6__["default"].get('/movies.json'); //    .then(function(response) {
  // handle success
...
/******/ });
//# sourceMappingURL=facet-87186274c402480ede15.js.map