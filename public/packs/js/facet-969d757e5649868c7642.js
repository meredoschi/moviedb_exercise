    ...
    computed: {
      ...
      category_name_options_revised: function category_name_options_revised() {
        ...
        for (var _i2 = 0, _Object$entries = _babel_runtime_corejs3_core_js_stable_object_entries__WEBPACK_IMPORTED_MODULE_7___default()(counts); _i2 < _Object$entries.length; _i2++) {
          ...
          var key = _ref2[0];
          var value = _ref2[1];
          var category_name_with_count = key + ' (' + value + ')';
      ...
      movieCategoryCounts: function movieCategoryCounts() {
        ...
        for (var _i3 = 0, _Object$entries3 = _babel_runtime_corejs3_core_js_stable_object_entries__WEBPACK_IMPORTED_MODULE_7___default()(counts); _i3 < _Object$entries3.length; _i3++) {
      ...
      average_ratings: function average_ratings() {
        var averages = []; //            let avg_ratings[]='';
        //      this.movies_jsn.forEach(function(movie) {
        //        avg_ratings.push(movie.ratings.stars);
...
/******/ });
//# sourceMappingURL=facet-969d757e5649868c7642.js.map