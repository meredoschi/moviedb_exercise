  ...
  var app = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_5__["default"]({
    ...
    methods: {
      ...
      invoke_destroy: function invoke_destroy(movie) {
        ...
        console.log(url);
        axios_on_rails__WEBPACK_IMPORTED_MODULE_6__["default"]["delete"](url).then(function (response) {//    this.movies_json = this.movies_json.filter(movie => movie.id !== id)
        })["catch"](function (e) {
...
/******/ });
//# sourceMappingURL=facet-ac9b8af7a62e8bccec50.js.map