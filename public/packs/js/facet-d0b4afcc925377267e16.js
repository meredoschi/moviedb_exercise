...
document.addEventListener('DOMContentLoaded', function () {
  var app = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_10__["default"]({
    ...
    computed: {
      ...
      category_name_options_revised: function category_name_options_revised() {
        var _context2;

        var arr = [];
        var counts = {};

        _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_9___default()(_context2 = app.movieCategoriesWithRepeats).call(_context2, function (x) {
          counts[x] = (counts[x] || 0) + 1;
        }); // https://stackoverflow.com/questions/14379274/how-to-iterate-over-a-javascript-object/14379304


        for (var _i2 = 0, _Object$entries = _babel_runtime_corejs3_core_js_stable_object_entries__WEBPACK_IMPORTED_MODULE_7___default()(counts); _i2 < _Object$entries.length; _i2++) {
          ...
          var key = _ref2[0];
          var value = _ref2[1];
          var category_name_with_count = key + ' (' + value + ')'; // console.log(category_name_with_count);
      ...
      movieCategoryCounts: function movieCategoryCounts() {
        ...
        for (var _i3 = 0, _Object$entries3 = _babel_runtime_corejs3_core_js_stable_object_entries__WEBPACK_IMPORTED_MODULE_7___default()(counts); _i3 < _Object$entries3.length; _i3++) {// console.log(key + ' (' + value + ')');
      ...
      filteredMovies: function filteredMovies() {
        ...
        return _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_6___default()(_context4 = app.filteredMoviesWithoutPagination).call(_context4, function (row, index) {
      ...
      category_names_with_counts: function category_names_with_counts() {
        var cat_names_raw = [];
        var cat_names = []; //              cat_names.push(this.all_label);

        for (var i = 0; i < this.total_number_of_movies; i++) {
          var name = this.movies_jsn[i].category.name; //  if (category_names.includes(name) === false) {

          cat_names_raw.push(name);
        }

        var elements = _babel_runtime_corejs3_core_js_stable_instance_reduce__WEBPACK_IMPORTED_MODULE_5___default()(cat_names_raw).call(cat_names_raw, function (b, c) {
          return (b[_babel_runtime_corejs3_core_js_stable_instance_find_index__WEBPACK_IMPORTED_MODULE_4___default()(b).call(b, function (d) {
            return d.el === c;
          })] || b[b.push({
            el: c,
            count: 0
        ...
        return _babel_runtime_corejs3_core_js_stable_instance_sort__WEBPACK_IMPORTED_MODULE_8___default()(cat_names).call(cat_names);
      },
      ...
      category_name_options: function category_name_options() {
        ...
        arr.push(this.category_names_with_counts); // console.log(this.category_names_with_counts);

        return _babel_runtime_corejs3_core_js_stable_instance_flat__WEBPACK_IMPORTED_MODULE_2___default()(arr).call(arr);
      },
      rating_stars: function rating_stars() {
        var _context5;

        var arr = [];

        _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_9___default()(_context5 = this.movies_jsn).call(_context5, function (movie) {
          arr.push(app.average_rating(movie));
        });
    ...
    methods: {
      ...
      movieTitleContainsText: function movieTitleContainsText(movies) {
        ...
        return _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_6___default()(movies).call(movies, function (movie) {
      ...
      moviesByCategory: function moviesByCategory(movies) {
        ...
        return _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_6___default()(movies).call(movies, function (movie) {
          ...
          if (_this5.selected_category != '' && _this5.selected_category != _this5.all_label) {
            ...
            return _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_3___default()(_context6 = _this5.selected_category).call(_context6, movie.category.name);
          } else {
            return true;
          }
        });
...
/******/ });
//# sourceMappingURL=facet-d0b4afcc925377267e16.js.map