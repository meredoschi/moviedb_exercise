  ...
  var app = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_10__["default"]({
    ...
    computed: {
      ...
      category_names_with_counts2: function category_names_with_counts2() {
        ...
        console.log(obj);
        this.movie_categories_freq = obj;
        return obj;
      },
      ...
      category_names_with_counts: function category_names_with_counts() {
        ...
        _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_9___default()(_context4 = app.movieCategoriesWithRepeats).call(_context4, function (x) {
      ...
      filteredMovies: function filteredMovies() {
        ...
        return _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_4___default()(_context6 = app.filteredMoviesWithoutPagination).call(_context6, function (row, index) {
      ...
      moviesByCategory: function moviesByCategory(movies) {
        ...
        return _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_4___default()(movies).call(movies, function (movie) {
          ...
          if (_this5.selected_category != '' && _this5.selected_category != _this5.all_label) {
            ...
            return _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_3___default()(_context7 = _this5.selected_category).call(_context7, movie.category.name); //                        return movie.category.name == ;
          } else {
            return true;
          }
        });
...
/******/ });
//# sourceMappingURL=facet-e2ac4d14e68591c8742f.js.map